...
ENV SENDGRID_DEFAULT_FROM_EMAIL = ${SENDGRID_DEFAULT_FROM_EMAIL}

ENV SENDGRID_INFO_FROM_EMAIL = ${SENDGRID_INFO_FROM_EMAIL}

ENV SENDGRID_NOTIFY_FROM_EMAIL = ${SENDGRID_NOTIFY_FROM_EMAIL}
